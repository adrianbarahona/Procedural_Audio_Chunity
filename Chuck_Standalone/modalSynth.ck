...
me.dir() => string path;
//set the signal path (noise through the envelope)
Noise n => ADSR hit;
...
while (true)
{
    // set the pitch, material, type of impact and attack (for slide mode)
    impact(1, "metal_1", "hit", 200);
    0.5::second => now;
}
